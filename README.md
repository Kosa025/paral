...
## Data
Audio data not included due to licensing constraints.
RAVDESS corpus: https://zenodo.org/record/1188976
AI-generated samples: ElevenLabs v3 (free tier)

## Tools
Python 3.12 | librosa | parselmouth | 
Hume AI API | SpeechBrain wav2vec2
